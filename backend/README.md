...
## Project Structure
    ...
    ├── testfigmaapp_dev_22726  # Django project configurations
...
1. Clone this repo and `cd testfigmaapp_dev_22726`
...
2. Clone this repo and `cd testfigmaapp_dev_22726`
